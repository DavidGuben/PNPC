...
return;alreadyCalled=true;self._handleTheJQueryDependency();};if(document.readyState=="complete"||document.readyState=="loaded"){fnToCall.call();}else{addEventListener(document,"DOMContentLoaded",fnToCall);addEventListener(window,"load",fnToCall);}}};AdobeIMS.call(adobeIMS);})();
    ...
    window.adobeIMS.config = {
        ...
        sunbreakScopeExpanded: "[update_profile.address.mail_to, update_profile.dob, update_profile.preferred_languages, acct_mgmt_api, update_profile.email, gnav, update_profile.industry, update_profile.last_name, update_profile.screen_name, update_profile.job_title, update_profile.first_name, update_profile.phonetic_name, update_profile.mrktPerm, update_profile.phoneNumber, update_profile.password, update_profile.job_function, update_profile.secondary_email]",
